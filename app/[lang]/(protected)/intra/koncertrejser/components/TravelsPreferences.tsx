...
import { EllipsisVerticalIcon, PencilSquareIcon, MinusCircleIcon } from "@heroicons/react/20/solid";

// Import the TravelsDeleteModal component
  ...
  return (
    <>
      <div>
                  ...
                  <div className="py-1">
                      ...
                      {({ active }) => (
                        <a
                          ...
                          className={classNames(
                            active ? "bg-tdk-blue-400 text-tdk-blue-800" : "text-tdk-blue-700",
                            "flex px-4 py-2 text-sm"
                          )}
                        >
                          <PencilSquareIcon className="mr-3 h-5 w-5 text-tdk-blue-700" aria-hidden="true" />
                          <span>Rediger</span>
                        </a>
                      )}
                    </Menu.Item>
                    <Menu.Item>
                      {({ active }) => (
                        ...
                        >
                          <MinusCircleIcon className="mr-3 h-5 w-5 text-tdk-blue-700" aria-hidden="true" />
                          <span>Slet</span>
                        </a>
                      )}
                    </Menu.Item>
        ...
        <p className="pb-6 text-sm text-tdk-blue-light-buttonsSubheadings"></p>
      </div>
    </>
  );
};
