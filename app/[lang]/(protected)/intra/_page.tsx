            ...
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                    ...
                    {/* {teams.map((team) => (
                      <li key={team.name}>
                        <a
                          ...
                          className={classNames(
                            team.current
                              ? "bg-tdk-blue-800 text-tdk-blue-200"
                              : "text-tdk-blue-400 hover:bg-tdk-blue-cardBg hover:text-tdk-blue-200",
                            "group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6"
                          )}
                        >
                ...
                <li className="-mx-6 mt-auto">
                  {/* <a
                    href="#"
                    className="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-tdk-blue-200 hover:bg-tdk-blue-cardBg"
                  >
                    <img
