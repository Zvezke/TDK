...
const UploadImage = ({ imageTitle }: Props) => {
  ...
  return (
    <>
      <label
        className="mt-2 rounded-md cursor-pointer bg-tdk-blue-800 px-2.5 py-1.5 text-xs font-semibold text-tdk-blue-200 shadow-sm hover:bg-tdk-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-tdk-blue-800"
