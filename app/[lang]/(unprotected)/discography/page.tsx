        ...
        <section className="">
          <div className="relative h-[90vh] lg:col-start-2 lg:col-end-3">
            <Image
              ...
              height={1080}
            />
            <div className="mx-auto flex h-screen w-full flex-col items-start justify-center lg:px-0 xl:max-w-screen-xl">
              <h2
                className="z-10 px-8 pb-4 text-center font-playfair text-[3.5rem] font-black leading-tight
            text-tdk-blue-light-headlines dark:text-tdk-blue-200 lg:px-0 lg:pb-8 lg:text-8xl"
              >
                {discography.title}
              </h2>
