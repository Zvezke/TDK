...
const Footer = () => {
  return (
    <footer className="flex flex-col text-tdk-blue-400 bg-tdk-blue-800 justify-center items-center py-12 absolute right-0 w-screen">
      <div className="pb-8">
        <ul className="flex gap-12 col-start-5 col-end-9">
          <li>
